...
defined('C_CACHE_PATH') 		or define('C_CACHE_PATH',   	C_APP_PATH.'Cache'.C_DIR_FIX);
defined('C_CONTROLLER_PATH') 	or define('C_CONTROLLER_PATH',  C_APP_PATH.'Controller'.C_DIR_FIX);
defined('C_COMMON_PATH') 		or define('C_COMMON_PATH',   	C_APP_PATH.'Common'.C_DIR_FIX);
defined('C_CONFIG_PATH') 		or define('C_CONFIG_PATH',   	C_COMMON_PATH.'Config'.C_DIR_FIX);
defined('C_MODEL_PATH') 		or define('C_MODEL_PATH',   	C_APP_PATH.'Model'.C_DIR_FIX);
defined('C_MODULE_PATH') 		or define('C_MODULE_PATH',   	C_APP_PATH.'Module'.C_DIR_FIX);
defined('C_VIEWS_PATH') 		or define('C_VIEWS_PATH',   	C_APP_PATH.'View'.C_DIR_FIX);
...
defined('C_ABSOLUT_URL') 		or define('C_ABSOLUT_URL',   	TRUE);
...
if( !defined('C_RES_URL') ){
    defined('C_RES_URL') or define('C_RES_URL', 	__ROOT__);
    defined('C_RES_PATH') or define('C_RES_PATH',	C_APP_PATH);
    defined('C_RES_ROOT') or define('C_RES_ROOT',	C_RES_PATH);
}else{
    defined('C_RES_ROOT') or define('C_RES_ROOT',	C_RES_URL);
}
// +--------------------------------------------------------------------------------------
// + 定义网站资源路径
// +--------------------------------------------------------------------------------------
...
defined('__UPLOAD_PATH__') 		or define('__UPLOAD_PATH__',  	str_replace(['http://'.HTTP_HOST.'/','//'],['','/'],DOCUMENT_ROOT.__PUBLIC__.'Upload'.C_DIR_FIX));
